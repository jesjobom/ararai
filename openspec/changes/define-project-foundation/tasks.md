...
- [x] Record initial product name and scope.
- [x] Record runtime direction.
- [x] Record Android target and environment constraints.
- [x] Record test flow split between container build and external ADB install.
- [x] Record TDD as the default development process.
