...
# ArarAI documentation

ArarAI is an open-source Android application for running configured language
models locally on supported devices.
...
Source code and complete project documentation are available in the
[ArarAI GitHub repository](https://github.com/jesjobom/ararai).
